...
map('v', '<A-h>', '<Esc>:BufferPrevious<CR>', default_opts)
map('v', '<A-l>', '<Esc>:BufferNext<CR>', default_opts)
map('v', '<A-d>', '<Esc>:BufferClose<cr>', default_opts)
map('v', '<A-\'>', '<Esc>:e #<cr>', default_opts)
